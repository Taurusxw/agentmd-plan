...
- `artifacts/AGENTS-27.6.0.md`: the concise global rule outline.
...
- `skills/seer-codex-rules/scripts/`: checks for rule size, Skill routing, synchronized state, and recovery snapshots.
...
3. Review `artifacts/AGENTS-27.6.0.md` and confirm that it matches your operating preferences.
